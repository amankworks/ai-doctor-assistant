"""Output parsers for the structured chat agent."""
...
from my_doctor_assistant.agents.structured_chat.prompt import FORMAT_INSTRUCTIONS
...
class StructuredChatOutputParser(AgentOutputParser):
    ...
    def parse(self, text: str) -> Union[AgentAction, AgentFinish]:
        """Parse the output of an LLM call into agent action/finish.
        
        Args:
            text: LLM output to parse
            
        Returns:
            AgentAction or AgentFinish object
...
class StructuredChatOutputParserWithRetries(AgentOutputParser):
    ...
    def get_format_instructions(self) -> str:
        """Returns formatting instructions for the output parser."""
        return FORMAT_INSTRUCTIONS

    def parse(self, text: str) -> Union[AgentAction, AgentFinish]:
        """Parse the output of an LLM call, with retries if needed.
    ...
    def from_llm(
        ...
        """Create an output parser with retry capability from an LLM.
        
        Args:
            llm: Language model to use for fixing outputs
            base_parser: Base parser to use
